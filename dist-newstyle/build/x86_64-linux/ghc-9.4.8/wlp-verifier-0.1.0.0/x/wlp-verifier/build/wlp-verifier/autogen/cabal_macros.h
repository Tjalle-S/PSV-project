...
/* package wlp-verifier-0.1.0.0 */
#ifndef VERSION_wlp_verifier
#define VERSION_wlp_verifier "0.1.0.0"
#endif /* VERSION_wlp_verifier */
#ifndef MIN_VERSION_wlp_verifier
#define MIN_VERSION_wlp_verifier(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_wlp_verifier */
...
#define CURRENT_COMPONENT_ID "wlp-verifier-0.1.0.0-inplace-wlp-verifier"
